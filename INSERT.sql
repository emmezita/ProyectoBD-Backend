...
VALUES
  ...
  ('2017-03-05', NULL, 3, 3),
  ('2018-04-20', NULL, 4, 4),
  ('2019-05-15', '2023-06-10', 5, 5),
  ('2020-06-10', '2023-09-15', 6, 6),
  ('2021-07-25', NULL, 7, 7),
...
VALUES
  ...
  ('2019-05-15', '2023-06-10', 800, 5, 5),
  ('2020-06-10', '2023-09-15', 900, 6, 6),
  ('2021-07-25', NULL, 550, 7, 7),
  ('2022-08-30', '2023-03-05', 450, 8, 8),
  ('2023-09-18', NULL, 1050, 9, 9),
...
INSERT INTO historico_precio_compra(precio_compra_valor,
	precio_compra_fecha_inicio, fk_historico_tasa_dolar,
	fk_presentacion_1, fk_presentacion_2, fk_presentacion_3)
VALUES
  (45.36, '2023/05/12', 2, 6, 2, 5),
  (76.23, '2023/05/13', 3, 6, 2, 6),
  (20.34, '2023/05/14', 4, 6, 2, 7),
  (83.23, '2023/05/15', 5, 9, 3, 8),
  (92.45, '2023/05/16', 6, 9, 2, 9),
  (32.92, '2023/05/17', 7, 9, 2, 18),
  (82.11, '2023/05/18', 8, 9, 2, 19),
  (30.99, '2023/05/19', 9, 9, 2, 20),
  (81.12, '2023/05/20', 10, 9, 2, 21),
  (24.47, '2023/05/21', 2, 9, 2, 22),
  (54.45, '2023/05/22', 3, 7, 2, 23),
  (22.45, '2023/05/23', 4, 6, 2, 24),
  (65.22, '2023/05/24', 5, 6, 2, 1),
  (87.23, '2023/05/25', 6, 6, 2, 2),
  (55.91, '2023/07/11', 7, 6, 2, 3),
  (66.66, '2023/07/12', 8, 6, 2, 4),
  (23.34, '2023/07/13', 9, 9, 2, 10),
  (87.12, '2023/07/14', 10, 9, 2, 11),
  (33.20, '2023/08/11', 1, 9, 6, 13),
  (98.34, '2023/11/26', 3, 9, 2, 12),
  (99.99, '2023/11/27', 4, 9, 2, 14),
  (76.33, '2023/11/28', 5, 9, 2, 15);
...
VALUES
  ...
  (35.25, '2023/05/13', 1, 6, 2, 6),
  (33.25, '2023/05/14', 1, 6, 2, 7),
  (41.25, '2023/05/15', 1, 9, 3, 8),
  (25.23, '2023/05/16', 1, 9, 2, 9),
  (20.25, '2023/05/17', 1, 9, 2, 18),
  (37.25, '2023/05/18', 1, 9, 2, 19),
  (20.45, '2023/05/19', 1, 9, 2, 20),
  (23.52, '2023/05/20', 1, 9, 2, 21),
  (25.25, '2023/05/21', 1, 9, 2, 22),
  (30.25, '2023/05/22', 1, 7, 2, 23),
  (35.25, '2023/05/23', 1, 6, 2, 24),
  (33.25, '2023/05/24', 1, 6, 2, 1),
  (41.25, '2023/05/25', 1, 6, 2, 2),
  (25.23, '2023/05/26', 1, 6, 2, 3),
  (20.25, '2023/05/27', 1, 6, 2, 4),
  (37.25, '2023/05/28', 1, 9, 2, 10),
  (20.45, '2023/05/29', 1, 9, 2, 11),
  (23.52, '2023/05/30', 1, 9, 6, 13),
  (25.25, '2023/05/31', 1, 9, 2, 12),
  (30.25, '2023/06/01', 1, 9, 2, 14),
  (35.25, '2023/06/02', 1, 9, 2, 15),
...
VALUES
  (28.23, '2023/10/01', 1, 1, 6, 2, 5),
  (87.43, '2023/10/02', 1, 1, 6, 2, 6),
  (98.26, '2023/10/03', 1, 1, 6, 2, 7),
  (12.41, '2023/10/04', 1, 1, 9, 3, 8),
  (89.89, '2023/10/05', 1, 1, 9, 2, 9),
  (45.12, '2023/10/06', 1, 1, 9, 2, 18),
  (19.46, '2023/10/07', 1, 1, 9, 2, 19),
  (47.94, '2023/10/08', 1, 1, 9, 2, 20),
  (45.12, '2023/10/09', 1, 1, 9, 2, 21),
  (28.21, '2023/10/10', 1, 1, 9, 2, 22),
  (28.29, '2023/10/13', 1, 1, 7, 2, 23),
  (88.11, '2023/10/14', 1, 1, 6, 2, 24),
  (77.77, '2023/10/15', 1, 1, 6, 2, 1),
  (11.99, '2023/10/16', 1, 1, 6, 2, 2),
  (12.88, '2023/10/17', 1, 1, 6, 2, 3),
  (15.31, '2023/10/18', 1, 1, 6, 2, 4),
  (22.22, '2023/10/19', 1, 1, 9, 2, 10),
  (98.12, '2023/10/20', 1, 1, 9, 2, 11),
  (22.77, '2023/10/21', 1, 1, 9, 6, 13),
  (21.11, '2023/10/22', 1, 1, 9, 2, 12),
  (33.33, '2023/10/23', 1, 1, 9, 2, 14),
  (12.34, '2023/10/11', 1, 1, 9, 2, 15),
  (77.22, '2023/10/12', 1, 1, 7, 2, 16);
...
VALUES
  (50.77,'2023/11/01', 1, 1, 6, 2, 6),
  (70.12,'2023/11/02', 1, 1, 6, 2, 7),
  (80.46,'2023/11/03', 1, 1, 9, 3, 8),
  (90.87,'2023/11/04', 1, 1, 9, 2, 9),
  (80.55,'2023/11/05', 1, 1, 9, 2, 18),
  (70.77,'2023/11/06', 1, 1, 9, 2, 19),
  (60.23,'2023/11/07', 1, 1, 9, 2, 20),
  (50.21,'2023/11/08', 1, 1, 9, 2, 21),
  (50.11,'2023/11/09', 1, 1, 9, 2, 22),
  (70.22,'2023/11/10', 1, 1, 7, 2, 23),
  (80.33,'2023/11/11', 1, 1, 6, 2, 24),
  (90.44,'2023/11/12', 1, 1, 6, 2, 1),
  (50.55,'2023/11/13', 1, 1, 6, 2, 2),
  (60.66,'2023/11/14', 1, 1, 6, 2, 3),
  (70.88,'2023/11/15', 1, 1, 6, 2, 4),
  (80.77,'2023/11/16', 1, 1, 9, 2, 10),
  (90.99,'2023/11/17', 1, 1, 9, 2, 11),
  (70.01,'2023/11/18', 1, 1, 9, 6, 13),
  (70.21,'2023/11/19', 1, 1, 9, 2, 12),
  (50.32,'2023/11/20', 1, 1, 9, 2, 14),
  (50.43,'2023/11/21', 1, 1, 9, 2, 15),
  (60.54,'2023/11/22', 1, 1, 7, 2, 16),
  (70.65,'2023/11/23', 1, 1, 7, 2, 17);

INSERT INTO factura(factura_fecha, factura_subtotal, factura_total, fk_cliente_natural,
					fk_cliente_juridico, fk_contrato_empleo)
VALUES
  -- Clientes naturales
  ('2023/11/23', 56.58, 57.00, 21, NULL, 1),
  ('2023/10/12', 56.58, 57.00, 21, NULL, 2),
  ('2023/07/20', 56.58, 57.00, 22, NULL, 3),
  ('2023/02/10', 56.58, 57.00, 22, NULL, 4),
  ('2023/10/31', 56.58, 57.00, 23, NULL, 5),
  ('2023/05/19', 56.58, 57.00, 23, NULL, 6),
  ('2023/09/22', 56.58, 57.00, 24, NULL, 7),
  ('2022/11/23', 56.58, 57.00, 24, NULL, 8),
  ('2022/10/12', 56.58, 57.00, 25, NULL, 9),
  ('2022/07/20', 56.58, 57.00, 25, NULL, 10),
  ('2022/02/10', 56.58, 57.00, 26, NULL, 11),
  ('2022/10/31', 56.58, 57.00, 26, NULL, 12),
  ('2022/05/19', 56.58, 57.00, 27, NULL, 13),
  ('2022/09/22', 56.58, 57.00, 27, NULL, 14),
  ('2021/10/12', 56.58, 57.00, 28, NULL, 15),
  ('2021/07/20', 56.58, 57.00, 28, NULL, 16),
  ('2021/02/10', 56.58, 57.00, 29, NULL, 17),
  ('2021/10/31', 56.58, 57.00, 29, NULL, 18),
  ('2021/05/19', 56.58, 57.00, 30, NULL, 19),
  ('2021/09/22', 56.58, 57.00, 30, NULL, 20),
  
  -- Clientes juridicos
  ('2023/11/24', 56.58, 57.00, NULL, 1, 1),
  ('2023/10/13', 56.58, 57.00, NULL, 1, 2),
  ('2023/07/21', 56.58, 57.00, NULL, 2, 3),
  ('2023/02/11', 56.58, 57.00, NULL, 2, 4),
  ('2023/11/01', 56.58, 57.00, NULL, 3, 5),
  ('2023/05/20', 56.58, 57.00, NULL, 3, 6),
  ('2023/09/23', 56.58, 57.00, NULL, 4, 7),
  ('2022/11/24', 56.58, 57.00, NULL, 4, 8),
  ('2022/10/13', 56.58, 57.00, NULL, 5, 9),
  ('2022/07/21', 56.58, 57.00, NULL, 5, 10),
  ('2022/02/11', 56.58, 57.00, NULL, 6, 11),
  ('2022/10/30', 56.58, 57.00, NULL, 6, 12),
  ('2022/05/20', 56.58, 57.00, NULL, 7, 13),
  ('2022/09/23', 56.58, 57.00, NULL, 7, 14),
  ('2021/10/13', 56.58, 57.00, NULL, 8, 15),
  ('2021/07/22', 56.58, 57.00, NULL, 8, 16),
  ('2021/02/14', 56.58, 57.00, NULL, 9, 17),
  ('2021/10/30', 56.58, 57.00, NULL, 9, 18),
  ('2021/05/15', 56.58, 57.00, NULL, 10, 19),
  ('2021/09/20', 56.58, 57.00, NULL, 10, 20);

INSERT INTO detalle_factura(detalle_factura_cantidad, detalle_factura_precio_unitario, fk_factura, 
...
INSERT INTO historico_punto(punto_valor, punto_fecha_inicio, fk_tienda)
VALUES
  (234.23, '2023/11/26', 1),
  (543.32, '2023/11/27', 1),
  (982.87, '2023/11/28', 1),
  ...
  (222.33, '2023/10/29', 1),
  (666.66, '2023/10/30', 1);
  (53.15, '2023/07/01', 1, 1, 6, 2, 5),
  (57.41, '2023/07/02', 1, 1, 6, 2, 6),
  (55.15, '2023/07/03', 1, 1, 6, 2, 7),
  (65.15, '2023/07/04', 1, 1, 9, 3, 8),
  (60.15, '2023/07/05', 1, 1, 9, 2, 9),
  (65.15, '2023/07/06', 1, 1, 9, 2, 18),
  (63.15, '2023/07/07', 1, 1, 9, 2, 19),
  (54.15, '2023/07/08', 1, 1, 9, 2, 20),
  (81.15, '2023/07/09', 1, 1, 9, 2, 21),
  (59.15, '2023/07/10', 1, 1, 9, 2, 22),
  (54.15, '2023/07/11', 1, 1, 7, 2, 23),
  (57.41, '2023/07/12', 1, 1, 6, 2, 24),
  (55.15, '2023/07/13', 1, 1, 6, 2, 1),
  (64.15, '2023/07/14', 1, 1, 6, 2, 2),
  (67.15, '2023/07/15', 1, 1, 6, 2, 3),
  (63.15, '2023/07/16', 1, 1, 6, 2, 4),
  (60.15, '2023/07/17', 1, 1, 9, 2, 10),
  (67.15, '2023/07/18', 1, 1, 9, 2, 11),
  (68.15, '2023/07/19', 1, 1, 9, 6, 13),
  (78.15, '2023/07/20', 1, 1, 9, 2, 12),
  (57.15, '2023/07/21', 1, 1, 9, 2, 14),
