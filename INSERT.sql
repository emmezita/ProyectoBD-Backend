...
VALUES
  (45.36, '2023/05/12', 2, 2, 3, 4),
  (76.23, '2023/05/13', 3, 3, 4, 5),
  (20.34, '2023/05/14', 4, 4, 5, 6),
  (83.23, '2023/05/15', 5, 5, 6, 7),
  (92.45, '2023/05/16', 6, 6, 7, 8),
  (32.92, '2023/05/17', 7, 7, 8, 9),
  (82.11, '2023/05/18', 8, 8, 9, 10),
  (30.99, '2023/05/19', 9, 9, 10, 11),
  (81.12, '2023/05/20', 10, 10, 11, 12),
  (24.47, '2023/05/21', 2, 2, 12, 13),
  (54.45, '2023/05/22', 3, 4, 13, 14),
  (22.45, '2023/05/23', 4, 6, 14, 15),
  (65.22, '2023/05/24', 5, 8, 15, 16),
  (87.23, '2023/05/25', 6, 10, 16, 17),
  (55.91, '2023/07/11', 7, 1, 17, 18),
  (66.66, '2023/07/12', 8, 3, 18, 19),
  (23.34, '2023/07/13', 9, 5, 19, 20),
  (87.12, '2023/07/14', 10, 7, 20, 21),
  (33.20, '2023/08/11', 1, 9, 21, 22),
  (98.34, '2023/11/26', 3, 4, 22, 23),
  (99.99, '2023/11/27', 4, 7, 23, 24),
  (76.33, '2023/11/28', 5, 10, 24, 1);
...
INSERT INTO historico_precio_venta(precio_venta_valor, precio_venta_fecha_inicio,
  ...
  fk_inventario_almacen_3)
VALUES
  (28.23, '2023/10/01', 1, 6, 2, 5),
  (87.43, '2023/10/02', 1, 6, 2, 6),
  (98.26, '2023/10/03', 1, 6, 2, 7),
  (12.41, '2023/10/04', 1, 9, 3, 8),
  (89.89, '2023/10/05', 1, 9, 2, 9),
  (45.12, '2023/10/06', 1, 9, 2, 18),
  (19.46, '2023/10/07', 1, 9, 2, 19),
  (47.94, '2023/10/08', 1, 9, 2, 20),
  (45.12, '2023/10/09', 1, 9, 2, 21),
  (28.21, '2023/10/10', 1, 9, 2, 22),
  (12.34, '2023/10/11', 1, 9, 2, 23),
  (77.22, '2023/10/12', 1, 9, 2, 22),
  (28.29, '2023/10/13', 1, 7, 2, 23),
  (88.11, '2023/10/14', 1, 6, 2, 24),
  (77.77, '2023/10/15', 1, 6, 2, 1),
  (11.99, '2023/10/16', 1, 6, 2, 2),
  (12.88, '2023/10/17', 1, 6, 2, 3),
  (15.31, '2023/10/18', 1, 6, 2, 4),
  (22.22, '2023/10/19', 1, 9, 2, 10),
  (98.12, '2023/10/20', 1, 9, 2, 11),
  (22.77, '2023/10/21', 1, 9, 6, 13),
  (21.11, '2023/10/22', 1, 9, 2, 12),
  (33.33, '2023/10/23', 1, 9, 2, 14);

-- para tienda
  INSERT INTO historico_precio_venta(precio_venta_valor, precio_venta_fecha_inicio,
  fk_historico_tasa_dolar, fk_inventario_tienda_1, fk_inventario_tienda_2,
  fk_inventario_tienda_3)
VALUES
  (50.77,'2023/11/01', 1, 6, 2, 6),
  (70.12,'2023/11/02', 1, 6, 2, 7),
  (80.46,'2023/11/03', 1, 9, 3, 8),
  (90.87,'2023/11/04', 1, 9, 2, 9),
  (80.55,'2023/11/05', 1, 9, 2, 18),
  (70.77,'2023/11/06', 1, 9, 2, 19),
  (60.23,'2023/11/07', 1, 9, 2, 20),
  (50.21,'2023/11/08', 1, 9, 2, 21),
  (50.11,'2023/11/09', 1, 9, 2, 22),
  (70.22,'2023/11/10', 1, 7, 2, 23),
  (80.33,'2023/11/11', 1, 6, 2, 24),
  (90.44,'2023/11/12', 1, 6, 2, 1),
  (50.55,'2023/11/13', 1, 6, 2, 2),
  (60.66,'2023/11/14', 1, 6, 2, 3),
  (70.88,'2023/11/15', 1, 6, 2, 4),
  (80.77,'2023/11/16', 1, 9, 2, 10),
  (90.99,'2023/11/17', 1, 9, 2, 11),
  (70.01,'2023/11/18', 1, 9, 6, 13),
  (70.21,'2023/11/19', 1, 9, 2, 12),
  (50.32,'2023/11/20', 1, 9, 2, 14),
  (50.43,'2023/11/21', 1, 9, 2, 15),
  (60.54,'2023/11/22', 1, 7, 2, 16),
  (70.65,'2023/11/23', 1, 7, 2, 17);